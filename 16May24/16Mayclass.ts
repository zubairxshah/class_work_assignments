...
let newNumbers : number[] = [1,2,3,4,5,6];
let arrayU : (string|number|boolean)[]= ['Shah',5, 'world', 4, true]; // type annoting an array fixes the data type insertion


let newArray :string[] = ['Maria', 'Shah', 'Alvi'];
console.log (newArray[0]); // Accessing specific data using index numbers

let teachers : string[] = ['Maria', 'Hamza', 'Ameen'];
...
let names :string[] = ['Jack', 'Paul', 'John', 'Clive', 'Mark'];
names[2] = 'Norton';
console.log (names);
