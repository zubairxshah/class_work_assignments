...
async function printWithDelay(message) {
...
async function resolveBothPromises() {
...
async function ResolvingPromises(prmiseInArray) {
...
async function multiplyWithPromise(num) {
